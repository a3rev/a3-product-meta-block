		...
		<div { ...useBlockProps() }>
			<details class="wccom-product-collapsible-list__item" open="">
				...
				<div class="wccom-product-collapsible-list__collapsible-content">
					...
					<p class="wccom-product-box__paragraph">Documentation is regularly updated with new features and examples</p>
				</div>
			</details>
		</div>
	);
